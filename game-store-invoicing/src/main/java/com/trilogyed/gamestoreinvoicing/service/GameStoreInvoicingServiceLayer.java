...
import com.trilogyed.gamestoreinvoicing.controller.GameStoreCatalogClient;
...
public class GameStoreInvoicingServiceLayer {
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ConsoleViewModel console = client.getConsole(invoice.getItemId());
            ...
            TShirtViewModel tshirt = client.getTShirt(invoice.getItemId());
